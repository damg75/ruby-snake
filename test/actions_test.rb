...
class ActionTest < Minitest::Test 
    ...
    def test_change_direction_invalid
        ...
        actual_state = Actions::change_direction(@initial_state, Model::Directions::UP)
        assert_equal actual_state, expected_state
    ...
    def test_change_direction_valid
        ...
        expected_state = Model::State.new(
            ...
            Model::Food.new(4, 4),
            Model::Grid.new(8, 12),
            Model::Directions::LEFT,
            false
        )
        
        actual_state = Actions::change_direction(@initial_state, Model::Directions::LEFT)
        assert_equal actual_state, expected_state
